...
from rewards.auto_encoder.model.auto_encoder import AutoEncoder
from rewards.auto_encoder.data_utils import batch_iter
...
def train(train_x, train_y, word_dict):
    with tf.Session() as sess:
        ...
        summary_writer = tf.summary.FileWriter("auto_encoder_weights", sess.graph)
        ...
        for batch_x, _ in batches:
            eval(batch_x)
        saver.save(sess, "/home/saman/Desktop/thesis_/thesis_DERSS/rewards/auto_encoder/"
