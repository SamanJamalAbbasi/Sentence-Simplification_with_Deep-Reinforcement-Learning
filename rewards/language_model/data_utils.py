...
file_dir = "/home/saman/Desktop/thesis_/thesis_DERSS/data/wikismall/wikismall_final/small_train_output.txt"
...
def build_word_dict():
    if not os.path.exists("/home/saman/Desktop/thesis_/thesis_DERSS/rewards/language_model/lm_word_dict.pickle"):
        contents = input_text
        words = list()
